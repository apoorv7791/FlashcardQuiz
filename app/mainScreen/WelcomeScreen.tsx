                ...
                <View style={styles.recentActivity}>
                    ...
                    {quizResults && (
                        <View style={styles.activityItem}>
                            <Text style={styles.activityText}>Last Quiz Score: {quizResults.score}/{quizResults.total}</Text>
                            <Text style={styles.activityDate}>Completed on: {new Date(quizResults.timestamp).toLocaleDateString()}</Text>
                        </View>
                    )}
                </View>
            </View>
